...
def demo_dynamic_gsi():
    ...
    # Create some tasks
    task1 = memory.create_new(TaskResource, {
    ...
    task2 = memory.create_new(TaskResource, {
    ...
    task3 = memory.create_new(TaskResource, {
    ...
    project = memory.create_new(ProjectResource, {
        "name": "New Website",
        "status": "planning",
        "owner": "charlie",
        "team": "web",
    ...
    for i in range(7):
        project = memory.update_existing(project, {
